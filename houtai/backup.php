...
$mysqldb="webhuan";          //name of database
include("mydb.php");
$d=new db($mysqlhost,$mysqluser,$mysqlpwd,$mysqldb);//创建了一个数据库操作对象
/*----------------------------------------------------界面----------------------------------------------*/
if(!$_POST['act']){//没提交备份eff8fd之前，界面显示 
?>
<style>
body{
background:#396;
...
<div class="main">
<p class="bian">备份数据</p>
<div style="background:#FFF;border:#98a7ac 1px solid;width:600px;padding:150px 0 0 180px;height:290px;">
