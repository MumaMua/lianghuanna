    ...
    <div class="gb_z">
    	<div class="gb_box">
        	<div class="wel">
                ...
                <!---------------------------搜索留言与管理员登录---------------------------------->
                <form action="guestbook.php" method="get"  accept-charset="utf-8" class="ly">
    			搜索留言：	<input type="search" name="sou" value="search" onFocus="this.value='';" 
                 ...
                 <form  action="admin_login.php" class="form1" method="post">
               <input type="submit" value="管理员登录" class="guanli" name="guanli">
                </form>
                 <form  action="update_admin.php" class="form1" method="post">
               <input type="submit" value="修改密码" class="xiugai" name="xiugai">
                </form>
                <form class="form1" action="out_login.php" method="post" onclick="if(confirm('您确定要退出吗？'))
    {return true;}else{return false;}">
               <input type="submit" value="退出" class="tuichu" name="tuichu">
               </form>
            </div>
            <div class="gb_g">
        ...
        Math.random()"/><br />
                ...
                <!---------------右边的自定义头像奥------------------------------->
                    ...
                    <label for="user_1"><img src="image/1.jpg"/></label>
                    <input class="user_1" type="radio" name="photo" value="image/1.jpg"/>
                    <label for="user_2"><img src="image/2.jpg"/></label>
                    <input class="user_2" type="radio" name="photo" value="image/2.jpg"/>
                    <label for="user_3"><img src="image/3.jpg"/></label>
                    <input class="user_3" type="radio" name="photo" value="image/3.jpg"/>
                    <label for="user_4"><img src="image/4.jpg"/></label>
                    <input class="user_4" type="radio" name="photo" value="image/4.jpg"/>
                    <label for="user_5"><img src="image/5.jpg"/></label>
                    <input class="user_5" type="radio" name="photo" value="image/5.jpg"/>
                    <label for="user_6"><img src="image/6.jpg"/></label>
                    <input class="user_6" type="radio" name="photo" value="image/6.jpg" />                  
...
<?php
    if(!empty($_GET[sou])){
              ...
              if ($cur_page==1) {
                ...
                首页
                上一页
            <a href='guestbook.php?page=<?php echo $cur_page+1; ?>&sou=<?php echo $_GET[sou];?>'>下一页</a>
             <a  href='guestbook.php?page=<?php echo $pagecount;?>&sou=<?php echo $_GET[sou];?>'>尾页</a>
                <?php
            }elseif ($cur_page==$pagecount) {
            ?>
            <a href='guestbook.php?page=1'>首页</a>
            <a href='guestbook.php?page=<?php echo $cur_page-1; ?>&sou=<?php echo $_GET[sou];?>'>上一页</a>
            下一页
            尾页
            <?php
            }else {
        ...
        <?php
            ...
            if ($cur_page==1) {
                ...
                首页
                上一页
                <a href='guestbook.php?page=<?php echo $cur_page+1; ?>'>下一页</a>
                <a  href='guestbook.php?page=<?php echo $pagecount;?>'>尾页</a>
                <?php
            }elseif ($cur_page==$pagecount) {
            ?>
            <a href='guestbook.php?page=1'>首页</a>
            <a href='guestbook.php?page=<?php echo $cur_page-1; ?>'>上一页</a>
            下一页
            尾页
            <?php
            }else {
...
?>           </div>
	...
	<div class="banquan"><a>版权所有||梁欢娜个人网页||1643148250@qq.com</a></div>
